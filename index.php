...
<head>
  ...
  <link rel="shortcut icon" href="images\deli.jpg" type="image/x-icon">
  ...
  <div class="hero_area">
    ...
    <header class="header_section">
      ...
      <section class="slider_section ">
        ...
        <section class="recipes_section layout_padding">
          <div class="container">
            ...
            <div class="recipes_container">
              <div class="carousel-wrap ">
                <div class="recipes owl-carousel">
                  <div class="item">
                    <div class="box ">
                      <div class="img-box">
                  ...
                  <div class="item">
                    <div class="box ">
                      ...
                      <div class="detail-box">
                        <h5>
                        Homemade Traditional Cuisines                        </h5>
                        <p>
                          when looking at its layout. The point of using Lorem Ipsum is
                          that it has a more-or-less normal
                        </p>
              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="info_detail">
                    ...
                    <p>
                      An innovative chef and recipe organization that is redefining culinary experinces around the world. We select a variety of recipes from famous chefs to provide culinary inspiration for all tastes. The platform encourages community interaction by connecting food enthusiasts and professionals alike. Join us for a savoury journey of creativity, competence, and culinary enjoyment.
                    </p>
                  </div>
                </div>
